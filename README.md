...
🚀 使い方
ダウンロード: Releases から最新のZipファイルをダウンロードして解凍します。同梱されている avifenc.exe と exiftool.exe は必ずそのまま解凍し、スマホ写真圧縮くん.exeと同一フォルダに置いてください。
実行: スマホ写真圧縮くん.exe を起動します。
